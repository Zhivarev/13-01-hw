# Домашнее задание к занятию "`13.1. «Уязвимости и атаки на информационные системы»`" - `Живарев Игорь`
...
![Название скриншота](img/13.01-01.png)
`Обнаруженные уязвимости при агресивном сканировании:`
![Название скриншота](img/13.01-02.png)
`Обнаруженные уязвимости при агресивном сканировании и использовании скрипта vulners.nse:`

```
╭─shaman@banner /usr/share/nmap/scripts 
╰─$ nmap -A --script vulners.nse 192.168.20.100
Starting Nmap 7.80 ( https://nmap.org ) at 2023-03-24 09:16 MSK
...
```
`Обнаруженная уязвимость с описанием на сайте https://www.exploit-db.com/exploits/18221`
![Название скриншота](img/13.01-03.png)
`Обнаруженная уязвимость с описанием на сайте https://www.exploit-db.com/exploits/34133`
![Название скриншота](img/13.01-04.png)
`Обнаруженная уязвимость с описанием на сайте https://www.exploit-db.com/exploits/10579`
![Название скриншота](img/13.01-05.png)


`Обнаруженные уязвимости при агресивном сканировании без использования скриптов:`
![Название скриншота](img/13.01-10.png)
`Обнаруженные уязвимости при использовании ключа "-sV" - детальное исследование портов для определения версий служб:`
![Название скриншота](img/13.01-11.png)
...
![Название скриншота](img/13.01-09.png)
